...
export default function CoupleMessage() {
    ...
    return (
        ...
        <div className="bg-[url('/assets/backmid.png')] bg-cover bg-no-repeat">
            <div className="lg:h-595 md:h-520 h-510">
                ...
                <div className="flex flex-col justify-center items-center lg:mt-20 mt-18">
                    <h2 className="lg:text-3xl text-2xl text-center text-white lg:pt-6 font-cormorant-upright">Please help us capture our special day, use the hashtag</h2>
                    <h2 className="lg:text-2xl text-xl text-center text-white pt-2 font-cormorant"> #FromRiaToKataria</h2>
